...
public class ModelJabaliTobilloDossssssshhhh<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("tobillomod_2", "model_jabali_tobillo_dossssssshhhh"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition root = partdefinition.addOrReplaceChild("root", CubeListBuilder.create().texOffs(77, 37).addBox(0.0F, -18.0F, -9.0F, 0.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(77, 37)
				.addBox(1.0F, -18.0F, -9.0F, 0.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(77, 37).addBox(1.0F, -18.0F, -3.0F, 0.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 22.0F, 0.0F));
		PartDefinition head = root.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(38, 28).addBox(-5.0F, -5.0F, -9.0F, 10.0F, 10.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(44, 0).addBox(-4.0F, 0.0F, -14.0F, 8.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(44, 23)
						.addBox(-4.0F, 0.0F, -15.0F, 8.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(82, 58).addBox(1.0F, -6.0F, -7.0F, 0.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(82, 58)
						.addBox(-1.0F, -6.0F, -7.0F, 0.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(82, 58).addBox(0.0F, -6.0F, -7.0F, 0.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(77, 37).addBox(0.0F, -7.0F, -12.0F, 0.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(77, 37)
				.addBox(-1.0F, -7.0F, -12.0F, 0.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(77, 37).addBox(-1.0F, -7.0F, -18.0F, 0.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -11.0F, 9.0F));
