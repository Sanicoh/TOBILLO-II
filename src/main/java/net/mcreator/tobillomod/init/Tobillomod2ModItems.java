...
import net.mcreator.tobillomod.item.PolishcowdefeatItem;
...
public class Tobillomod2ModItems {
	...
	public static final RegistryObject<Item> POLISHCOWDEFEAT = REGISTRY.register("polishcowdefeat", () -> new PolishcowdefeatItem());
